...
#define PROC_NAME "ram_202010040"
...
static int __init ram_202010040_init(void)
{
...
static void __exit ram_202010040_exit(void)
{
    proc_remove(proc_entry);
    printk(KERN_INFO "Modulo RAM descargado\n");
}

module_init(ram_202010040_init);
module_exit(ram_202010040_exit);