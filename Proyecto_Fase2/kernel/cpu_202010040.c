...
#define PROC_NAME "cpu_202010040"
...
static int __init cpu_202010040_init(void)
{
...
static void __exit cpu_202010040_exit(void)
{
    proc_remove(proc_entry);
    printk(KERN_INFO "Modulo CPU descargado\n");
}

module_init(cpu_202010040_init);
module_exit(cpu_202010040_exit);